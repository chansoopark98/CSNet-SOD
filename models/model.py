...
def csnet_model(weights='pascal_voc', input_tensor=None, input_shape=(224, 224, 3), classes=20, OS=16):
    """custum resnet101"""
    ...
    # c5 = base.get_layer('conv5_block3_out').output # 7x7
    # # skip1 = base.get_layer('conv2_block3_out').output
    # c2 = base.get_layer('conv3_block4_out').output # 28x28
